...
# LSTM_03 : BARTモデル?
# (参考) https://qiita.com/m__k/items/841950a57a0d7ff05506
def set_trialLSTM3(f_path, df, wordindex, ep=50, embdim=100, trainrate=0.7, modelpath="model"):
    categories = df['pos'].unique()
    print(categories)
...
def test_trialLSTM3(f_path,df,wordindex,modelpath,embdim=100,text=""):
    categories = df['pos'].unique()
    word2index=wordindex
